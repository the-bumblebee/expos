...
```
$ cd ~/myexpos/spl/
$ ./spl ~/expos-roadmap/stage6/spl_progs/haltprog.spl
$ ./spl ~/expos-roadmap/stage6/spl_progs/os_startup.spl
```
...
```
# load --init $HOME/expos-roadmap/stage6/expl_progs/squares.xsm
# load --int=10 $HOME/expos-roadmap/stage6/spl_progs/haltprog.xsm
# load --exhandler $HOME/expos-roadmap/stage6/spl_progs/haltprog.xsm
# load --os $HOME/expos-roadmap/stage6/spl_progs/os_startup.xsm
# exit
```
